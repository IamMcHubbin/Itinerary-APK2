...
// GitHub Pages serves this project from a /<repo-name>/ subpath.
const base = process.env.GITHUB_PAGES === 'true' ? '/Itinerary-APK2/' : '/'
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: 'A day-by-day itinerary for your trip to Japan',
        theme_color: '#1c2951',
